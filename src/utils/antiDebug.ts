...
// Detecta abertura de DevTools (verificação contínua)
...
// Sobrescreve console (desabilita logs)
...
export const initAntiDebug = () => {
    ...
    // Desabilitar console (OPCIONAL - comentado para não atrapalhar você no desenvolvimento)
    // disableConsole();

    // Log de proteção (só você vê no dev)
